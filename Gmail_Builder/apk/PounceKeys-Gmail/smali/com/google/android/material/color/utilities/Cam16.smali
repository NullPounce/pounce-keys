...
.method static fromIntInViewingConditions(ILcom/google/android/material/color/utilities/ViewingConditions;)Lcom/google/android/material/color/utilities/Cam16;
    ...
    cmpg-double v60, v54, v56

    if-gez v60, :cond_0

    .line 247
    add-double v56, v54, v58

    goto :goto_0

    .line 248
    :cond_0
    cmpl-double v56, v54, v58

    if-ltz v56, :cond_1

    sub-double v56, v54, v58
    ...
    const-wide/high16 v60, 0x4010000000000000L    # 4.0

    div-double v6, v60, v6

    div-double v62, v4, v32
    ...
    .line 268
    .local v6, "q":D
    const-wide v62, 0x403423d70a3d70a4L    # 20.14

    cmpg-double v64, v56, v62

    if-gez v64, :cond_2

    add-double v58, v56, v58
    ...
    invoke-static/range {v62 .. v63}, Ljava/lang/Math;->cos(D)D

    move-result-wide v40

    const-wide v62, 0x400e666666666666L    # 3.8

    add-double v40, v40, v62

    const-wide/high16 v62, 0x3fd0000000000000L    # 0.25

    mul-double v40, v40, v62

    .line 270
    .local v40, "eHue":D
    const-wide v62, 0x40ae0c4ec4ec4ec5L    # 3846.153846153846
    ...
    mul-double v62, v62, v87

    const-wide v64, 0x3fd3851eb851eb85L    # 0.305

    add-double v64, v48, v64

    move-wide/from16 v89, v0

    .end local v0    # "a":D
    .local v89, "a":D
    div-double v0, v62, v64
    ...
    mul-double v65, v65, v2

    invoke-virtual/range {p1 .. p1}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v67

    add-double v67, v67, v60
    ...
    const-wide/high16 v65, 0x4049000000000000L    # 50.0

    mul-double v95, v60, v65

    .local v95, "s":D
    move-wide/from16 v71, v95

    .line 281
    const-wide v60, 0x3ffb333333333334L    # 1.7000000000000002

    mul-double v60, v60, v4

    const-wide v65, 0x3f7cac083126e979L    # 0.007

    mul-double v65, v65, v4

    const-wide/high16 v67, 0x3ff0000000000000L    # 1.0

    add-double v65, v65, v67

    div-double v97, v60, v65

    .local v97, "jstar":D
    move-wide/from16 v73, v97

    .line 282
    const-wide v60, 0x3f9758e219652bd4L    # 0.0228

    mul-double v60, v60, v32

    invoke-static/range {v60 .. v61}, Ljava/lang/Math;->log1p(D)D

    move-result-wide v60

    const-wide v65, 0x4045ee08fb823ee0L    # 43.859649122807014

    mul-double v99, v60, v65

    .line 283
    .local v99, "mstar":D
    invoke-static/range {v79 .. v80}, Ljava/lang/Math;->cos(D)D

    move-result-wide v60

    mul-double v101, v99, v60

    .local v101, "astar":D
    move-wide/from16 v75, v101

    .line 284
    invoke-static/range {v79 .. v80}, Ljava/lang/Math;->sin(D)D

    move-result-wide v60

    mul-double v103, v99, v60

    .local v103, "bstar":D
    move-wide/from16 v77, v103

    .line 286
    new-instance v105, Lcom/google/android/material/color/utilities/Cam16;
    ...
    invoke-direct/range {v60 .. v78}, Lcom/google/android/material/color/utilities/Cam16;-><init>(DDDDDDDDD)V
